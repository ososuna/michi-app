  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        ...
        <TouchableOpacity style={{ backgroundColor: colors.primary, borderRadius: 8, width: 160, height: 48, alignItems: 'center', marginTop: 20, maxHeight: 48, flexDirection: 'row' }}>
          <View style={{ flex: 9 }}>
